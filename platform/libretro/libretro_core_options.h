...
struct retro_core_option_v2_definition option_defs_us[] = {
   ...
   },
   {
      ...
      "MSH2 clock speed",
      NULL,
      "Change SH2 Master clock speed of the emulated 32X add-on chip. Can reduce slowdown, but may cause heavy glitches.",
      NULL,
      "hacks",
      {
         { "11000kHz", NULL },
   ...
   },
   {
      ...
      "SSH2 clock speed",
      NULL,
      "Change SH2 Slave clock speed of the emulated 32X add-on chip. Can reduce slowdown, but may cause glitches.",
      NULL,
      "hacks",
      {
         { "11000kHz", NULL },
